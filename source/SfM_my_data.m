...
datapath = '../data/my_data/object/';

%% Define constants and parameters
% Constants ( need to be set )
number_of_pictures                  = 10;     % number of input pictures
...
max_number_of_features  = 20000; % maximum number of features in 1 image
max_number_of_points    = 10000; % maximum number of reconstructed points

% Matrices
K               = [ 2078.44319  0.000000     1296.59919;
                    0.000000    2068.51171   715.14629;
...
for i = 1:number_of_pictures
  ...
  img_path = strcat('../data/my_data/object/', img_name);
  I = imread(img_path);
  I = single(rgb2gray(I));
  [f, d] = vl_sift(I);
  nf = length(f);
...
DisplayFeatureExtraction(datapath, 3, 4, Feature, num_Feature);
...
DisplayFeatureMatching(datapath, 3, 4, Feature, num_Match, Match);
...
filename = sprintf('../report/view3d/my_data/init_views.ply');
...
while(sum(Image_selected)<number_of_pictures)
  ...
  filename = sprintf('../report/view3d/my_data/%02dviews.ply', new);
